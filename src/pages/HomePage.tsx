...
import { ArrowRight, Sparkles, Shield, Eye, Instagram, ChevronRight, Layers } from 'lucide-react';
import { useStore } from '../context/StoreContext';
import { EmptyProductState } from '../components/EmptyProductState';

export const HomePage: React.FC = () => {
  const { setCurrentPage, setSelectedCategoryFilter, bannerConfig, products, setSelectedProductId } = useStore();
